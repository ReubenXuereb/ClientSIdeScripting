  ...
  <div class='container'>
    <form @submit.prevent='updateInfo'>
      ...
      <div class="form-group row">
        <label for="idCard" class="col-md-2 col-form-label">Identification</label>
        <div class="col-sm-6">
          <input @blur="$v.idCard.$touch()" id="idCard" class="form-control" type="text" v-model.trim="idCard"/>
      ...
      <!--Gender-->
      <div class="form-group row">
        <label for="name" class="col-md-2 col-form-label">Gender</label>
        <div class="col-sm-6">
      ...
      <div class="form-group row">
        ...
        <button data-toggle="modal" data-target="#myModal"
                ...
                ||!idCard||!mobile||!email||!nationality||!club
                ||!status" class="btn btn-primary">Submit</button>
      </div>
    </form>
  </div>
...
export default {
  ...
  validations() {
    return {
      ...
      dob: { required },
      gender: { required },
      idCard: { required, minLength: minLength(5), maxLength: maxLength(8), alphaNum },
  ...
  methods: {
    ...
    async updateInfo() {
      ...
      //we will submit only if the form does not contain anything invalid
        //Update current entry
          const response = await fetch("https://car-repair-and-service-centre-default-rtdb.europe-west1.firebasedatabase.app/contact/" + this.$route.params.memberId + ".json", {
            method: 'PATCH',
            headers: {
    ...
    async getData(){
      ...
      try {
        const response = await fetch("https://car-repair-and-service-centre-default-rtdb.europe-west1.firebasedatabase.app/contact/" + id + ".json", {
          method: 'GET'
        })
